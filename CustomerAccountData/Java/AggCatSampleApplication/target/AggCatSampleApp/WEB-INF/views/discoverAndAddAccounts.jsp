...
<body>
    ...
    <div class="popup"><div class="container">
        <h2>Discover/Add Accounts</h2>
        
        <div class="filter">
            <form method="post" action="discoverAndAddAccountsSubmit.htm">
            	<div class="row">
                	<label>Institution Id</label>
                	<label><c:out value='${sessionScope["InstitutionId"]}'/></label>
                   <!--  <select name="InstitutionId">
                    	<c:forEach var="institutionId" items="${InstitutionIdList}">
