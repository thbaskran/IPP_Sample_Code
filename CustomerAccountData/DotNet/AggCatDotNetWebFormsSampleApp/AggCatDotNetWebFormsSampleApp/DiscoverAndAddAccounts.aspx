<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DiscoverAndAddAccounts.aspx.cs" Inherits="AggCatDotNetWebFormsSampleApp.DiscoverAndAddAccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:DropDownList ID="institutions" runat="server" OnSelectedIndexChanged="institutions_SelectedIndexChanged">
    </asp:DropDownList>
