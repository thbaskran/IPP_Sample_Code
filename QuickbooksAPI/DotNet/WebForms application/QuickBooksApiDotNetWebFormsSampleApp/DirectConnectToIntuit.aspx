<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectConnectToIntuit.aspx.cs"
         Inherits="QuickBooksApiDotNetWebFormsSampleApp.DirectConnectToIntuit" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ipp="">
    ...
    menuProxy: '<%= Request.Url.GetLeftPart(UriPartial.Authority) + "/" +
                        ConfigurationManager.AppSettings["menuProxy"] %>',
    grantUrl: '<%= Request.Url.GetLeftPart(UriPartial.Authority) + "/" +
                               ConfigurationManager.AppSettings["grantUrl"] %>'
});

intuit.ipp.anywhere.directConnectToIntuit(); </script>
    </head>
    <body>
